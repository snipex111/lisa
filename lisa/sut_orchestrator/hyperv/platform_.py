...
class HypervPlatform(Platform):
    ...
    def _initialize(self, *args: Any, **kwargs: Any) -> None:
        ...
        # Copy pwershell script onto the host
        ...
        self.device_pool_impl = HyperVDevicePoolImpl(
            self._server,
            self._assignable_devices_script,
            self._hyperv_runbook,
        )
    ...
    def _delete_nodes(self, environment: Environment, log: Logger) -> None:
        def _delete_node(node_ctx: NodeContext, wait_delete: bool) -> None:
            ...
            if node_ctx.is_device_passthrough_set:
                self.device_pool_impl._put_devices_into_pool(node_ctx)
...
class HyperVDevicePoolImpl(BaseDevicePoolImpl):
    def __init__(
        self,
        node: RemoteNode,
        assignable_device_script: PurePath,
        ...
        self._server = node
        self._assignable_devices_script = assignable_device_script
